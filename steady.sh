...
BAD=0
NONVOLUNTARY=60
NONVOLUNTARYCHECK=60
VOLUNTARY=60
VOLUNTARYCHECK=60
I=1
BOT=TeleRedStar  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "               \e[01;34m                    by Tele_Sudo               \e[00;37;40m"
echo ""
cat << EOF
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script v1.2 Tele_sudo 2016 " >&2
	echo ""
	echo -e "\e[0m"
