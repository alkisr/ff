...
local reply_id = msg ['id'] 
if matches[1]==  'list' and is_momod(msg) then 
local help4 = [[ 
...
local reply_id = msg ['id'] 
if matches[1]== 'list' and not is_momod(msg) then 
    local help = '⚠ للمشرفين فقط' 
    reply_msg(reply_id, help, ok_cb, false) 
    end 
local reply_id = msg ['id'] 
if matches[1]==  'list1' and is_momod(msg) then 
local kisr3 = [[ 
...
..'〰 <b>groupname:</b> '..msg.to.title..'\n' 
..'📅 <b>Date :</b> '.. os.date('!%A %B:%d:%Y\n', timestamp) 
reply_msg(reply_id, kisr3, ok_cb, false) 
end 
local reply_id = msg ['id'] 
if matches[1]== 'list1' and not is_momod(msg) then 
    local kisr5 = '⚠ للمشرفين فقط' 
    reply_msg(reply_id, kisr5, ok_cb, false) 
    end
 local reply_id = msg ['id'] 
if matches[1]==  'list2' and is_momod(msg) then 
local kisr4 = [[ 
<b>Hello in your orders Put
lـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّـٌّl 
/setwlc⌘⌘⌘⌘⌘: 👋🏼لوضع ترحيب 
...
..'〰 <b>groupname:</b> '..msg.to.title..'\n' 
..'📅 <b>Date :</b> '.. os.date('!%A %B:%d:%Y\n', timestamp) 
reply_msg(reply_id, kisr4, ok_cb, false) 
end 
local reply_id = msg ['id'] 
if matches[1]== 'list2' and not is_momod(msg) then 
    local kisr6 = '⚠ للمشرفين فقط' 
    reply_msg(reply_id, kisr6, ok_cb, false) 
    end        
local reply_id = msg ['id'] 
if matches[1]==  'list3' and is_momod(msg) then 
local kisr =[[ 
...
..'〰 <b>groupname:</b> '..msg.to.title..'\n' 
..'📅 <b>Date :</b> '.. os.date('!%A %B:%d:%Y\n', timestamp) 
reply_msg(reply_id, kisr, ok_cb, false) 
end 
local reply_id = msg ['id'] 
if matches[1]== 'list3' and not is_momod(msg) then 
    local kisr7 = '⚠ للمشرفين فقط' 
    reply_msg(reply_id, kisr7, ok_cb, false) 
    end 
...
..'〰 <b>groupname:</b> '..msg.to.title..'\n' 
..'📅 <b>Date :</b> '.. os.date('!%A %B:%d:%Y\n', timestamp) 
reply_msg(reply_id, kisr2, ok_cb, false) 
end 
local reply_id = msg ['id'] 
